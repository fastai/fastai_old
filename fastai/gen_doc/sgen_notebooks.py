...
import argparse
from fastai.gen_doc.gen_notebooks import generate_all, update_all, update_module_page, create_module_page, import_mod
...
def update_notebooks(source_path=None, dest_path=None, update_html=False, update_nb=True, html_path=None, create_missing=False):
