...
def update_notebooks(source_path=None, dest_path=None, do_all=False, update_html=True, update_nb=False, update_nb_links=True, html_path=None, create_missing_docs=False):
    ...
    if not do_all and source_path is None: print('Please provide source path or set do_all=True to run')
