...
def fit_one_cyle(learn:Learner, max_lr:float, cyc_len:int, moms:tuple=(0.95,0.85), div_factor:float=10., pct_end:float=0.1,
                 wd:float=0.):
...
def to_fp16(learn:Learner, loss_scale=512, flat_master=False):
